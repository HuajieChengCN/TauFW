  ...
  for era in eras:
    for channel in channels:
      ...
      if channel in ['mutau']:
        ...
        createinputs(fname,samplesets['TES0.970'],  observables,bins,filter=varprocs['TES0.970'])
        #createinputs(fname,samplesets['TES0.972'],  observables,bins,filter=varprocs['TES0.972'])
        #createinputs(fname,samplesets['TES0.974'],  observables,bins,filter=varprocs['TES0.974'])
        #createinputs(fname,samplesets['TES0.976'],  observables,bins,filter=varprocs['TES0.976'])
        #createinputs(fname,samplesets['TES0.978'],  observables,bins,filter=varprocs['TES0.978'])
        createinputs(fname,samplesets['TES0.980'],  observables,bins,filter=varprocs['TES0.980'])
        #createinputs(fname,samplesets['TES0.982'],  observables,bins,filter=varprocs['TES0.982'])
        #createinputs(fname,samplesets['TES0.984'],  observables,bins,filter=varprocs['TES0.984'])
        #createinputs(fname,samplesets['TES0.986'],  observables,bins,filter=varprocs['TES0.986'])
        #createinputs(fname,samplesets['TES0.988'],  observables,bins,filter=varprocs['TES0.988'])
        createinputs(fname,samplesets['TES0.990'],  observables,bins,filter=varprocs['TES0.990'])
        #createinputs(fname,samplesets['TES0.992'],  observables,bins,filter=varprocs['TES0.992'])
        #createinputs(fname,samplesets['TES0.994'],  observables,bins,filter=varprocs['TES0.994'])
        #createinputs(fname,samplesets['TES0.996'],  observables,bins,filter=varprocs['TES0.996'])
        #createinputs(fname,samplesets['TES0.998'],  observables,bins,filter=varprocs['TES0.998'])
        createinputs(fname,samplesets['TES1.000'],  observables,bins,filter=varprocs['TES1.000']  )
        #createinputs(fname,samplesets['TES1.002'],  observables,bins,filter=varprocs['TES1.002']  )
        #createinputs(fname,samplesets['TES1.004'],  observables,bins,filter=varprocs['TES1.004']  )
        #createinputs(fname,samplesets['TES1.006'],  observables,bins,filter=varprocs['TES1.006']  )
        #createinputs(fname,samplesets['TES1.008'],  observables,bins,filter=varprocs['TES1.008']  )
        createinputs(fname,samplesets['TES1.010'],  observables,bins,filter=varprocs['TES1.010']  )
        #createinputs(fname,samplesets['TES1.012'],  observables,bins,filter=varprocs['TES1.012']  )
        #createinputs(fname,samplesets['TES1.014'],  observables,bins,filter=varprocs['TES1.014']  )
        #createinputs(fname,samplesets['TES1.016'],  observables,bins,filter=varprocs['TES1.016']  )
        #createinputs(fname,samplesets['TES1.018'],  observables,bins,filter=varprocs['TES1.018']  )
        createinputs(fname,samplesets['TES1.020'],  observables,bins,filter=varprocs['TES1.020']  )
        #createinputs(fname,samplesets['TES1.022'],  observables,bins,filter=varprocs['TES1.022']  )
        #createinputs(fname,samplesets['TES1.024'],  observables,bins,filter=varprocs['TES1.024']  )
        #createinputs(fname,samplesets['TES1.026'],  observables,bins,filter=varprocs['TES1.026']  )
        #createinputs(fname,samplesets['TES1.028'],  observables,bins,filter=varprocs['TES1.028']  )
        createinputs(fname,samplesets['TES1.030'],  observables,bins,filter=varprocs['TES1.030']  )
        ...
        createinputs(fname,samplesets['TES0.970shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.970'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.972shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.972'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.974shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.974'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.976shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.976'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.978shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.978'],replaceweight=["idweight_2","idweightUp_2"])
        createinputs(fname,samplesets['TES0.980shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.980'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.982shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.982'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.984shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.984'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.986shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.986'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.988shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.988'],replaceweight=["idweight_2","idweightUp_2"])
        createinputs(fname,samplesets['TES0.990shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.990'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.992shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.992'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.994shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.994'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.996shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.996'],replaceweight=["idweight_2","idweightUp_2"])
        #createinputs(fname,samplesets['TES0.998shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES0.998'],replaceweight=["idweight_2","idweightUp_2"])
        createinputs(fname,samplesets['TES1.000shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.000'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.002shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.002'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.004shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.004'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.006shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.006'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.008shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.008'],replaceweight=["idweight_2","idweightUp_2"]  )
        createinputs(fname,samplesets['TES1.010shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.010'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.012shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.012'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.014shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.014'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.016shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.016'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.018shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.018'],replaceweight=["idweight_2","idweightUp_2"]  )
        createinputs(fname,samplesets['TES1.020shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.020'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.022shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.022'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.024shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.024'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.026shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.026'],replaceweight=["idweight_2","idweightUp_2"]  )
        #createinputs(fname,samplesets['TES1.028shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.028'],replaceweight=["idweight_2","idweightUp_2"]  )
        createinputs(fname,samplesets['TES1.030shape_tidUp'],  observables,bins,htag="shape_tidUp",       filter=varprocs['TES1.030'],replaceweight=["idweight_2","idweightUp_2"]  )
        ...
        createinputs(fname,samplesets['TES0.970shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.970'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.972shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.972'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.974shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.974'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.976shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.976'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.978shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.978'],replaceweight=["idweight_2","idweightDown_2"] )
        createinputs(fname,samplesets['TES0.980shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.980'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.982shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.982'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.984shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.984'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.986shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.986'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.988shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.988'],replaceweight=["idweight_2","idweightDown_2"] )
        createinputs(fname,samplesets['TES0.990shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.990'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.992shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.992'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.994shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.994'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.996shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.996'],replaceweight=["idweight_2","idweightDown_2"] )
        #createinputs(fname,samplesets['TES0.998shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES0.998'],replaceweight=["idweight_2","idweightDown_2"] )
        createinputs(fname,samplesets['TES1.000shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.000'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.002shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.002'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.004shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.004'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.006shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.006'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.008shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.008'],replaceweight=["idweight_2","idweightDown_2"]   )
        createinputs(fname,samplesets['TES1.010shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.010'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.012shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.012'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.014shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.014'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.016shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.016'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.018shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.018'],replaceweight=["idweight_2","idweightDown_2"]   )
        createinputs(fname,samplesets['TES1.020shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.020'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.022shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.022'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.024shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.024'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.026shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.026'],replaceweight=["idweight_2","idweightDown_2"]   )
        #createinputs(fname,samplesets['TES1.028shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.028'],replaceweight=["idweight_2","idweightDown_2"]   )
        createinputs(fname,samplesets['TES1.030shape_tidDown'],  observables,bins,htag="shape_tidDown",     filter=varprocs['TES1.030'],replaceweight=["idweight_2","idweightDown_2"]   )
        ...
        createinputs(fname,samplesets['TES0.970shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.970'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.972shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.972'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.974shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.974'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.976shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.976'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.978shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.978'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        createinputs(fname,samplesets['TES0.980shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.980'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.982shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.982'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.984shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.984'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.986shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.986'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.988shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.988'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        createinputs(fname,samplesets['TES0.990shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.990'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.992shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.992'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.994shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.994'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.996shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.996'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.998shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES0.998'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]  )
        createinputs(fname,samplesets['TES1.000shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.000'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.002shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.002'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.004shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.004'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.006shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.006'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.008shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.008'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        createinputs(fname,samplesets['TES1.010shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.010'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.012shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.012'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.014shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.014'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.016shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.016'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.018shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.018'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        createinputs(fname,samplesets['TES1.020shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.020'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.022shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.022'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.024shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.024'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.026shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.026'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.028shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.028'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        createinputs(fname,samplesets['TES1.030shape_dyUp'],  observables,bins,htag="shape_dyUp",        filter=varprocs['TES1.030'],replaceweight=["zptweight","(zptweight+0.1*(zptweight-1))"]    )
        ...
        createinputs(fname,samplesets['TES0.970shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.970'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.972shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.972'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.974shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.974'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.976shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.976'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.978shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.978'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        createinputs(fname,samplesets['TES0.980shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.980'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.982shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.982'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.984shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.984'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.986shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.986'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.988shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.988'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        createinputs(fname,samplesets['TES0.990shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.990'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.992shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.992'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.994shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.994'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.996shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.996'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        #createinputs(fname,samplesets['TES0.998shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES0.998'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]  )
        createinputs(fname,samplesets['TES1.000shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.000'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.002shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.002'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.004shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.004'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.006shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.006'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.008shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.008'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        createinputs(fname,samplesets['TES1.010shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.010'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.012shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.012'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.014shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.014'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.016shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.016'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.018shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.018'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        createinputs(fname,samplesets['TES1.020shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.020'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.022shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.022'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.024shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.024'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.026shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.026'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        #createinputs(fname,samplesets['TES1.028shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.028'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
        createinputs(fname,samplesets['TES1.030shape_dyDown'],  observables,bins,htag="shape_dyDown",      filter=varprocs['TES1.030'],replaceweight=["zptweight","(zptweight-0.1*(zptweight-1))"]    )
